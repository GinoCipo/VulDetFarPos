...
bilstm_model.add(Bidirectional(LSTM(units = 50, return_sequences = True, input_shape = (200, 200))))
...
bilstm_model.fit(X_train, y_train, epochs = 50, batch_size = 128, callbacks=[EarlyStopping(monitor='val_loss',min_delta=0.0001)])
